...
def test_stage_dag_is_topologically_sorted() -> None:
    ...
    assert ordered[-1] == "final_evidence_classification"
...
def test_downstream_selection_is_transitive() -> None:
    ...
    assert "final_evidence_classification" in affected
...
def test_until_residual_attribution_execution_plan_uses_transitive_prerequisites_only() -> None:
    assert execution_plan(until_stage="residual_attribution") == [
        "validate",
        "prepare_inputs",
        "map_identifiers",
        "sequence_analysis",
...
def test_until_final_evidence_classification_plan_uses_prerequisites_only() -> None:
    assert execution_plan(until_stage="final_evidence_classification") == [
        "validate",
        "prepare_inputs",
        "map_identifiers",
        "sequence_analysis",
